...
public class BookReservationController {
    ...
    public String postBookReservation(@RequestParam(required = false) String bookTitle,
        ...
        // Ако bookTitle е null, стави default вредност
        ...
        int numberOfCopies;
        try {
            numberOfCopies = Integer.parseInt(numCopies);
        } catch (NumberFormatException e) {
            numberOfCopies = 1;
            model.addAttribute("error", "Invalid number of copies. Defaulting to 1.");
        }
